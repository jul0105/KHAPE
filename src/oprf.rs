...
use rand::rngs::OsRng;
use voprf::{NonVerifiableClient, NonVerifiableClientBlindResult, NonVerifiableServer, NonVerifiableServerEvaluateResult};
...
pub fn server_evaluate(client_blind_result: NonVerifiableClientBlindResult<Group, Hash>) -> NonVerifiableServerEvaluateResult<Group, Hash> {
...
pub fn client_finish(client_blind_result: NonVerifiableClientBlindResult<Group, Hash>, server_evaluate_result: NonVerifiableServerEvaluateResult<Group, Hash>) -> Vec<u8> {
